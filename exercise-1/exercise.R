...
diamonds_sample <- sample_n(diamonds, size = 1000, replace = FALSE)
...
d1 <- ggplot(data = diamonds_sample) +
  geom_point(mapping = aes(x = carat, y = price), color = "blue", size = 0.1)
